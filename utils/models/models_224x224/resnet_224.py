...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # This improves the density_model by 0.2~0.3% according to https://arxiv.org/abs/1706.02677
...
def resnet18(pretrained=False, progress=True, **kwargs):
    r"""ResNet-18 density_model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
...
def resnet34(pretrained=False, progress=True, **kwargs):
    r"""ResNet-34 density_model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnet50(pretrained=False, progress=True, **kwargs):
    r"""ResNet-50 density_model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnet101(pretrained=False, progress=True, **kwargs):
    r"""ResNet-101 density_model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnet152(pretrained=False, progress=True, **kwargs):
    r"""ResNet-152 density_model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    r"""ResNeXt-50 32x4d density_model from
...
def resnext101_32x8d(pretrained=False, progress=True, **kwargs):
    r"""ResNeXt-101 32x8d density_model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def wide_resnet50_2(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-50-2 density_model from
...
def wide_resnet50_3(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-50-3 density_model
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
...
def wide_resnet50_4(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-50-4 density_model
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
...
def wide_resnet50_5(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-50-5 density_model
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
...
def wide_resnet50_6(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-50-6 density_model
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
...
def wide_resnet101_2(pretrained=False, progress=True, **kwargs):
    r"""Wide ResNet-101-2 density_model from
    `"Wide Residual Networks" <https://arxiv.org/pdf/1605.07146.pdf>`_
    The density_model is the same as ResNet except for the bottleneck number of channels
    which is twice larger in every block. The number of channels in outer 1x1
    convolutions is the same, e.g. last block in ResNet-50 has 2048-512-2048
