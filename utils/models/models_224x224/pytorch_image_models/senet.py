...
Original density_model: https://github.com/hujie-frank/SENet

ResNet code gently borrowed from
https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py

FIXME I'm deprecating this density_model and moving them to ResNet as I don't want to maintain duplicate
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, drop_rate=0.2,
        ...
        downsample_kernel_size (int): Kernel out_size for downsampling convolutions
