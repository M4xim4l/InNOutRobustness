...
def gluon_resnext101_32x4d(pretrained=False, **kwargs):
    """Constructs a ResNeXt-101 density_model.
    """
...
def gluon_seresnext50_32x4d(pretrained=False, **kwargs):
    """Constructs a SEResNeXt50-32x4d density_model.
    """
    model_args = dict(
...
def gluon_seresnext101_32x4d(pretrained=False, **kwargs):
    """Constructs a SEResNeXt-101-32x4d density_model.
    """
    model_args = dict(
...
def gluon_seresnext101_64x4d(pretrained=False, **kwargs):
    """Constructs a SEResNeXt-101-64x4d density_model.
    """
    model_args = dict(
...
def gluon_senet154(pretrained=False, **kwargs):
    """Constructs an SENet-154 density_model.
    """
    model_args = dict(
