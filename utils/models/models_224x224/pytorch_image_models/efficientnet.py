...
def _gen_mnasnet_a1(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    """Creates a mnasnet-a1 density_model.
...
def _gen_mnasnet_b1(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    """Creates a mnasnet-b1 density_model.
...
def _gen_spnasnet(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    """Creates the Single-Path NAS density_model from search targeted for Pixel1 phone.
...
def _gen_efficientnet(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    """Creates an EfficientNet density_model.
...
def _gen_efficientnet_edge(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    """ Creates an EfficientNet-EdgeTPU density_model
...
def _gen_efficientnet_condconv(
    ...
    """Creates an EfficientNet-CondConv density_model.
    ...
    # the expert_multiplier increases that on a per-density_model basis as with depth/channel multipliers
    model_kwargs = dict(
...
def _gen_efficientnet_lite(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    """Creates an EfficientNet-Lite density_model.
...
def _gen_mixnet_s(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    """Creates a MixNet Small density_model.
...
def _gen_mixnet_m(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    """Creates a MixNet Medium-Large density_model.
...
def fbnetc_100(pretrained=False, **kwargs):
    """ FBNet-C """
    if pretrained:
        # pretrained density_model trained with non-default BN epsilon
...
def mixnet_m(pretrained=False, **kwargs):
    """Creates a MixNet Medium density_model.
    """
    model = _gen_mixnet_m(
...
def mixnet_l(pretrained=False, **kwargs):
    """Creates a MixNet Large density_model.
    """
    model = _gen_mixnet_m(
...
def mixnet_xl(pretrained=False, **kwargs):
    """Creates a MixNet Extra-Large density_model.
...
def mixnet_xxl(pretrained=False, **kwargs):
    """Creates a MixNet Double Extra Large density_model.
    Not a paper spec, experimental def by RW w/ depth scaling.
    """
    model = _gen_mixnet_m(
...
def tf_mixnet_s(pretrained=False, **kwargs):
    """Creates a MixNet Small density_model. Tensorflow compatible variant
    """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mixnet_s(
...
def tf_mixnet_m(pretrained=False, **kwargs):
    """Creates a MixNet Medium density_model. Tensorflow compatible variant
    """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mixnet_m(
...
def tf_mixnet_l(pretrained=False, **kwargs):
    """Creates a MixNet Large density_model. Tensorflow compatible variant
    """
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_mixnet_m(
