...
def resnest14d(pretrained=False, **kwargs):
    """ ResNeSt-14d density_model. Weights ported from GluonCV.
    """
    model_kwargs = dict(
...
def resnest26d(pretrained=False, **kwargs):
    """ ResNeSt-26d density_model. Weights ported from GluonCV.
    """
    model_kwargs = dict(
...
def resnest50d(pretrained=False, **kwargs):
    """ ResNeSt-50d density_model. Matches paper ResNeSt-50 density_model, https://arxiv.org/abs/2004.08955
...
def resnest101e(pretrained=False, **kwargs):
    """ ResNeSt-101e density_model. Matches paper ResNeSt-101 density_model, https://arxiv.org/abs/2004.08955
...
def resnest200e(pretrained=False, **kwargs):
    """ ResNeSt-200e density_model. Matches paper ResNeSt-200 density_model, https://arxiv.org/abs/2004.08955
    Since this codebase supports all possible variations, 'e' for deep stem, stem_width 64, avg in downsample.
    """
    model_kwargs = dict(
...
def resnest269e(pretrained=False, **kwargs):
    """ ResNeSt-269e density_model. Matches paper ResNeSt-269 density_model, https://arxiv.org/abs/2004.08955
    Since this codebase supports all possible variations, 'e' for deep stem, stem_width 64, avg in downsample.
    """
    model_kwargs = dict(
