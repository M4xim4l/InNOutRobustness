...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True):
    ...
    if cfg is None or 'url' not in cfg or not cfg['url']:
        _logger.warning("Pretrained density_model URL is invalid, using random initialization.")
        return
    ...
    if num_classes == 1000 and cfg['num_classes'] == 1001:
        ...
        # completely discard fully connected for all other differences between pretrained and created density_model
