...
def res2net50_26w_4s(pretrained=False, **kwargs):
    """Constructs a Res2Net-50 26w4s density_model.
    Args:
...
def res2net101_26w_4s(pretrained=False, **kwargs):
    """Constructs a Res2Net-101 26w4s density_model.
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
    """
    model_args = dict(
...
def res2net50_26w_6s(pretrained=False, **kwargs):
    """Constructs a Res2Net-50 26w6s density_model.
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
    """
    model_args = dict(
...
def res2net50_26w_8s(pretrained=False, **kwargs):
    """Constructs a Res2Net-50 26w8s density_model.
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
    """
    model_args = dict(
...
def res2net50_48w_2s(pretrained=False, **kwargs):
    """Constructs a Res2Net-50 48w2s density_model.
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
    """
    model_args = dict(
...
def res2net50_14w_8s(pretrained=False, **kwargs):
    """Constructs a Res2Net-50 14w8s density_model.
    Args:
        pretrained (bool): If True, returns a density_model pre-trained on ImageNet
    """
    model_args = dict(
