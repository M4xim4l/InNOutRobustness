...
def _create_selecsls(variant, pretrained, model_kwargs):
    ...
    # this density_model can do 6 feature levels by default, unlike most others, leave as 0-4 to avoid surprises?
...
def selecsls42(pretrained=False, **kwargs):
    """Constructs a SelecSLS42 density_model.
    """
...
def selecsls42b(pretrained=False, **kwargs):
    """Constructs a SelecSLS42_B density_model.
    """
...
def selecsls60(pretrained=False, **kwargs):
    """Constructs a SelecSLS60 density_model.
    """
...
def selecsls60b(pretrained=False, **kwargs):
    """Constructs a SelecSLS60_B density_model.
    """
...
def selecsls84(pretrained=False, **kwargs):
    """Constructs a SelecSLS84 density_model.
    """
