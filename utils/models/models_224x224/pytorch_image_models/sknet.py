...
def skresnet18(pretrained=False, **kwargs):
    """Constructs a Selective Kernel ResNet-18 density_model.
...
def skresnet34(pretrained=False, **kwargs):
    """Constructs a Selective Kernel ResNet-34 density_model.
...
def skresnet50(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNet-50 density_model.
...
def skresnet50d(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNet-50-D density_model.
...
def skresnext50_32x4d(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNeXt50-32x4d density_model. This should be equivalent to
    the SKNet-50 density_model in the Select Kernel Paper
    """
    model_args = dict(
