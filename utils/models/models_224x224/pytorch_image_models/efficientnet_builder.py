...
def _decode_block_str(block_str):
    ...
    # if act_layer is None, the density_model default (passed to density_model init) will be used
...
class EfficientNetBuilder:
    ...
    def __init__(self, channel_multiplier=1.0, channel_divisor=8, channel_min=None,
        ...
        # state updated during build, consumed by density_model
        self.in_chs = None
        self.features = []
    ...
    def _make_block(self, ba, block_idx, block_count):
        ...
        # block act fn overrides the density_model default
        ...
        if bt == 'ir':
            ...
            assert False, 'Uknkown block type (%s) while building density_model.' % bt
    ...
    def __call__(self, in_chs, model_block_args):
        ...
        """
        _log_info_if('Building density_model trunk with %d stages...' % len(model_block_args), self.verbose)
        self.in_chs = in_chs
        ...
        for stack_idx, stack_args in enumerate(model_block_args):
            ...
            for block_idx, block_args in enumerate(stack_args):
                ...
                # stash feature module name and channel info for density_model feature extraction
                if extract_features:
                    feature_info = dict(
